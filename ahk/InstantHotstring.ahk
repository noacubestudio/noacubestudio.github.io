...
If LoadDefault = 1
{
  ControlClick, Button12, Instant Hotstring
}
Return
...
MsgBox Hotstrings added to the %SaveFile%.ahk file!
  MsgBox, 3, , Hotstrings added to the %SaveFile%.ahk file! Set as default
                    ?`rYes — Use this file on Startup
                    !`rNo — Keep old default
     IfMsgBox, Cancel
       Return
     IfMsgBox, Yes
       {
          RegWrite, REG_SZ, HKCU\Software\InstantHotstring, DefaultFile, %SaveFile%.ahk
        }
Return
